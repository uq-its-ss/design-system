...
class SideNavigation {
  constructor(nav, navClass) {
    ...
    this.toggleClass = `jsSideNavToggle`;
...
//let sideNavToggle = document.getElementsByClassName('uq-side-nav__list-item--has-subnav');
//let theText = document.querySelectorAll('.the-text');

/*sideNavToggle.onclick = function () { 
  sideNavToggle.classList.toggle('uq-side-nav__list-item--active uq-side-nav__list-item--open');
}*/