...
Use divs if there is significant amount of content.

## Using divs

<Canvas withSource="none" withToolbar>
  <Story height={220} id="components-accordion--using-divs" />
</Canvas>
...
Use lists if content is less and when the semantics of a list serves better with assistive technologies like screen readers.

<Canvas withSource="none" withToolbar>
  <Story height={220} id="components-accordion--using-lists" />
</Canvas>
