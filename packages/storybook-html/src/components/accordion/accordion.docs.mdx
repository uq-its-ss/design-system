...
```html
<div class="accordion" aria-label="Accordion button group">
...
```html
<ul class="accordion" aria-label="Accordion button group">
...
```html
<div class="accordion accordion--shaded" aria-label="Accordion button group">
    <div class="accordion__item">
...
```html
<div class="accordion accordion--secondary" aria-label="Accordion button group">
    <div class="accordion__item">
...
- Use secondary accordion example for smaller title font sizes.
...
- If the accordion content panel associated with an accordion title is visible, and if the accordion does not permit the content panel to be collapsed, the button element has aria-disabled set to true.
