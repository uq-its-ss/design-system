...
<form>
  ...
  <input type="text" id="firstname" name="firstname" aria-describedby="firstnameFeedback" aria-invalid="true" class="uq-input--error" />
  <span id="firstnameFeedback" aria-live="polite" class="uq-error-message">Enter your first name</span>
</form>
```
...
<form>
  ...
  <input type="text" id="username" name="username" aria-describedby="usernameFeedback" class="uq-input--success" />
  <span id="usernameFeedback" aria-live="polite" class="uq-success-message">Your chosen username is available</span>
</form>
```
...
<form>
  ...
  <!-- Implicit control-label association -->
  <label class="uq-label--inline">Keyword <input type="text" name="keyword" /></label>
</form>
```
...
<form>
  <label class="uq-label--error">Begin study in
    <select name="commencementyear" class="uq-input--error" aria-describedby="CommencementYearError" aria-invalid="true">
      <option value=""></option>
      <option value="2021">2021</option>
      <option value="2022">2022</option>
    </select>
    <span id="CommencementYearError" class="uq-error-message" aria-live="polite">Select the year you will commence study at UQ</span>
  </label>
</form>
```
...
<form>
  ...
  <div style="display: inline-block">
    <label for="CommencementYear" class="uq-label--inline">Begin study in</label>
...
```html
<form>
  <input id="Confirm" type="checkbox" name="confirm" aria-describedby="ConfirmFeedback" aria-invalid="true" class="uq-input--error" />
  <label for="Confirm" class="uq-label--error">I declare that the information I've provided is correct and true</label>
  <span id="ConfirmFeedback" aria-live="polite" class="uq-error-message">Make sure your details are correct and then check the declaration statement</span>
</form>
```
...
<form>
  <fieldset>
    ...
    <span id="semesterFeedback" aria-live="polite" class="uq-error-message"></span>
...
<form>
  <fieldset>
    ...
    <input id="Semester1" type="radio" name="semester" class="uq-input--error" aria-invalid="true" aria-describedby="semesterFeedback" />
    <label for="Semester2" class="uq-label--error">Semester 1</label><br/>
    <input id="Semester2" type="radio" name="semester" class="uq-input--error" aria-invalid="true" aria-describedby="semesterFeedback" />
    <label for="Semester2" class="uq-label--error">Semester 2</label>
    <span id="semesterFeedback" aria-live="polite" class="uq-error-message">Please select a semester</span>
  </fieldset>
</form>
```
