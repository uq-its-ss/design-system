...
In this category of the grid menu component, if the height of an item is bigger, the alignment of the items are taken care of.

<Story id="components-grid-menu--equalised" />

```html
<h3>Grid menu - equalised</h3>
<ul class="uq-grid-menu uq-grid-menu--equalised">
  <li class="uq-grid-menu__item"><a class="uq-grid-menu__link" href="#"><span class="uq-grid-menu__title">Refresh to see me equalise!</span></a></li>
