                      ...
                      <div class="megamenu__column">
                        ...
                        <div class="megamenu__menu">
                          <ul>
                            ...
                            <li><a href="https://research.uq.edu.au/research-support" data-gtm-label="Research > Research support, integrity and ethics">Research support, integrity and ethics</a></li>
          ...
          <form action="https://www.uq.edu.au/search/" method="get" data-gtm-action="Text search" data-gtm-form-action>
            <fieldset>
              <div class="uq-header__search-query">
                ...
                <input type="text" id="edit-q" name="q" value="" maxlength="128" placeholder="Search by keyword" autocomplete="off" class="uq-header__search-query-input" data-gtm-trigger="change" data-gtm-form-search>
