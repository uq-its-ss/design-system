      ...
      <nav class="slide-menu global-mobile-nav" id="global-mobile-nav"   aria-label="primary navigation mobile">
        <ul>
          <li class="uq-header__newglobal-nav-item" data-gtm-category="Primary header">
            <a class="uq-header__newglobal-nav-link global-mobile-nav__audience-link slide-menu__control" href="#">Study</a>
            <ul>
              <li>
          ...
          <li  class="uq-header__newglobal-nav-item" data-gtm-category="Primary header">
            <a  class="uq-header__newglobal-nav-link global-mobile-nav__audience-link slide-menu__control" href="#">Research</a>
            <ul>
              <li>
          ...
          <li  class="uq-header__newglobal-nav-item" data-gtm-category="Primary header">
            <a class="uq-header__newglobal-nav-link global-mobile-nav__audience-link slide-menu__control" href="#">Partners and community</a> 
            <ul>
              <li>
          ...
          <li class="uq-header__newglobal-nav-item" data-gtm-category="Primary header">
            <a class="uq-header__newglobal-nav-link global-mobile-nav__audience-link slide-menu__control" href="#">About</a>
            <ul>
              <li>
