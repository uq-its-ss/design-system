...
<Canvas withSource="none">
  <Story id="components-tabs--tabs-scrollable" />
</Canvas>
...
- The WAI-ARIA roles used are [role="tab"], [role="tablist"], [role="tabpanel"].
...
| tabListSelector | String | Optional | `[role="tablist"]` | Selector string of the tab lists. |
| tabSelector | String | Optional | `[role="tab"]` | Selector string of the tabs. |
| tabPanelSelector | String | Optional | `[role="tabpanel"]` | Selector string of the tab panels. |
