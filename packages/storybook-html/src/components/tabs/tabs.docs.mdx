...
- Tab active state: `tabindex = "0"`, classname `tabs__tab--active` is added, attribute `aria-selected = "true"`.
- Tab inactive state: `tabindex = "-1"`, classname `tabs__tab--active` is removed, attribute `aria-selected = "false"`.
- Tab panel active state: `tabindex = "0"`, classname `tabs__tab-panel--active` is added, attribute `hidden` is removed.
- Tab panel inactive state: `tabindex = "0"`, classname `tabs__tab-panel--active` is removed, attribute `hidden` is added.
...
| tabListSelector | String | Optional | `.tabs__tab-list` | Selector string of the tab lists. |
| tabSelector | String | Optional | `.tabs__tab` | Selector string of the tabs. |
| tabPanelSelector | String | Optional | `.tabs__tab-panel` | Selector string of the tab panels. |
