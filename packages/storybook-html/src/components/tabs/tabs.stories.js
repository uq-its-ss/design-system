...
export const tabsScrollable = () => {
  ...
  <div id="tabsScrollableExample" class="tabs tabs--outline">
    ...
    <div class="tabs__tab-panel" role="tabpanel" id="tab4-panel" aria-labelledby="tab4" tabindex="0" hidden="">
      <p>Tab4 panel text</p>
    </div>
    <div class="tabs__tab-panel" role="tabpanel" id="tab5-panel" aria-labelledby="tab5" tabindex="0" hidden="">
      <p>Tab5 panel text</p>
    </div>
