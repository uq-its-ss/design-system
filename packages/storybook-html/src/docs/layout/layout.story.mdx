...
| [Flexible grid](/?path=/docs/layout-grid--flexible-1#flexible-grid) | Auto-sizing grid. | Coming soon |
...
for laying out bold blocks of content. We recommend these options for situations
such as pull quotes, calls to action, landing pages etc.
