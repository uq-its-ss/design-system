...
To help you compose your pages, we have several options in our layout system
for you to choose from.

1. **`@uqds/grid`:** general use CSS grid classes.

| Name         | Description | Thumbnail |
| ------------ | ----------- | ------------------ |
| [Golden](/?path=/docs/layout-grid--golden#golden) | Inspired by [*The Golden Ratio*](https://www.canva.com/learn/what-is-the-golden-ratio/). A preset to give you a layout that is pleasing to the eye. | Coming soon |
| [Halves](/?path=/docs/layout-grid--halves#halves) | A two-column grid. | Coming soon |
| [Thirds](/?path=/docs/layout-grid--thirds#thirds) | A three-column grid. | Coming soon |
| [Quarters](/?path=/docs/layout-grid--quarters#quarters) | A four-column grid. | Coming soon |
| [Flexible grid](/?path=/docs/layout-grid--flexible-1#flexible-grid) | Auto-sizing column grid. | Coming soon |
| Scrolling grid | [TODO] A grid that scrolls horizontally on mobile. Useful for holding cards. | Coming soon |
| [6-8-12](/?path=/docs/layout-grid--twelve-eight-six#6-8-12-grid) | Advanced. The most flexible option. This is an implementation of our base grid (see below). | Coming soon |

2. **`@uqds/sections`:** CSS classes that combine layout and typography. Great
for laying out discrete blocks of content. We recommend these options for
situations such as pull quotes, calls to action, landing pages etc.

## Our base grid

Our layout system is built upon a 6-8-12 column strategy — our base grid.

### Specifications per breakpoint range
