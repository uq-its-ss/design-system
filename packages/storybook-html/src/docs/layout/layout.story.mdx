...
| [6-8-12](/?path=/docs/layout-grid--twelve-eight-six#6-8-12-grid) | Advanced. The most consistent, flexible implementation of our layout system. It is what our other layouts are built upon. | Coming soon |

> Currently, all our layout options can be used by installing or downloading the
> [`@uq-uidf/grid`](/?path=/docs/layout-grid--twelve-eight-six) package into your
> project.
