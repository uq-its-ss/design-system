...
<Canvas>
  {/* <Story height={170} id="components-blockquote--blockquote" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
...
<figure class="blockquote">
  ...
  <figcaption class="blockquote__footer">
    —Aldous Huxley,
    <cite
      ><a href="https://www.huxley.net/bnw/four.html" class="blockquote__link"
        >Brave New World</a
      ></cite
    >
  </figcaption>
...
<Canvas>
  {/* <Story height={170} id="components-blockquote--blockquote-light" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
