export default {
  ...
  argTypes: {
    checked: {
      name: "checked",
      control: "boolean",
      description: "Determines whether the input is currently selected or active.",
      table: {
    ...
    disabled: {
      name: "disabled",
      control: "boolean",
      description: "Disables the input, preventing user interaction and typically changing its visual styling to appear inactive.",
      table: {
        category: "State", // Groups the toggle switch
      },
    },
    required: {
      name: "required",
      control: "boolean",
      description: "Marks the field as mandatory, preventing form submission if the user leaves it unchecked or empty.",
      table: {
    ...
    ariaInvalid: {
      name: "aria-invalid",
      control: "boolean",
      description: "Indicates the input field has an invalid value, typically used for form validation.",
      table: {
        category: "Validation & Accessibility", // Groups the toggle switch
      },
    },
