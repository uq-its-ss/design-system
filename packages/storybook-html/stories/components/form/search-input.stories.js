...
export default {
  ...
  render: ({ label, placeholder, expand }) => {
    return `
    <div class="${classNames("uq-form uq-search-input", { "uq-search-input--expand": expand })}">
      <label for="search-input-text" class="visually-hidden">${label}</label>
      <input type="text" id="search-input-text" placeholder="${placeholder}" class="uq-form__input" />
