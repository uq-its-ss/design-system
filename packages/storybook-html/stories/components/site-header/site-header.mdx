...
<Canvas withToolbar>
  {/* <Story height={505} id="components-site-header--site-header-with-subnav" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
...
<Canvas withToolbar>
  {/* <Story height={200} id="components-site-header--site-header-without-subnav" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
