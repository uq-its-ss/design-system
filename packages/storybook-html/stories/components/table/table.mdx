...
<Canvas withToolbar>
  {/* <Story id="components-table--table" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
...
<Canvas withToolbar>
  {/* <Story id="components-table--table-classes" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
...
<Canvas withToolbar>
  {/* <Story id="components-table--table-multiple-headers" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
...
<Canvas withToolbar>
  {/* <Story id="components-table--table-irregular-headers" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
...
<Canvas withToolbar>
  {/* <Story id="components-table--table-multi-level-headers" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
...
<Canvas withToolbar>
  {/* <Story id="components-table--table-card" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
...
Reference: [https://www.w3.org/WAI/tutorials/tables/](https://www.w3.org/WAI/tutorials/tables/)
