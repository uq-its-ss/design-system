...
<Canvas sourceState="hidden">
  <Story of={TabsStories.tabsOutline} autoplay />
</Canvas>
...
<Canvas sourceState="hidden">
  <Story of={TabsStories.tabsMinimal} autoplay />
</Canvas>
...
<Canvas sourceState="hidden">
  <Story of={TabsStories.tabsLined} autoplay />
</Canvas>
...
<Canvas sourceState="hidden">
  <Story of={TabsStories.tabsWithIcon} autoplay />
</Canvas>
...
<Canvas sourceState="hidden">
  <Story of={TabsStories.tabsFullWidth} autoplay />
</Canvas>
...
<Canvas sourceState="hidden">
  <Story of={TabsStories.tabsSmall} autoplay />
</Canvas>
...
<Canvas sourceState="hidden">
  <Story of={TabsStories.tabsReversed} autoplay />
</Canvas>
