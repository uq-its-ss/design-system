...
<Canvas sourceState="hidden">
  {/* <Story id="components-tabs--tabs-outline" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
...
<div id="tabsDefaultExample" class="uq-tabs uq-tabs--outline">
  <div class="uq-tabs__tab-list-wrapper">
    <div class="uq-tabs__tab-list" role="tablist" aria-label="Tab List">
      <button
        class="uq-tabs__tab uq-tabs__tab--active"
        role="tab"
        aria-selected="true"
  ...
  <div
    class="uq-tabs__tab-panel uq-tabs__tab-panel--active"
    role="tabpanel"
    id="tab1-panel"
...
<Canvas sourceState="hidden">
  {/* <Story id="components-tabs--tabs-minimal" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

  <Story id="components-tabs--tabs-minimal" />
</Canvas>

```html
<div class="uq-tabs">...</div>
```

### Lined

<Canvas sourceState="hidden">
  {/* <Story id="components-tabs--tabs-lined" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

  <Story id="components-tabs--tabs-lined" />
</Canvas>

```html
<div class="uq-tabs uq-tabs--lined">...</div>
```

### With icon

<Canvas sourceState="hidden">
  {/* <Story id="components-tabs--tabs-with-icon" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
...
<Canvas sourceState="hidden">
  {/* <Story id="components-tabs--tabs-full-width" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

  <Story id="components-tabs--tabs-full-width" />
</Canvas>

```html
<div class="uq-tabs uq-tabs--outline uq-tabs--full-width">...</div>
```

### Small

<Canvas sourceState="hidden">
  {/* <Story id="components-tabs--tabs-small" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

  <Story id="components-tabs--tabs-small" />
</Canvas>

```html
<div class="uq-tabs uq-tabs--outline uq-tabs--small">...</div>
```

### Reversed

<Canvas sourceState="hidden">
  {/* <Story id="components-tabs--tabs-reversed" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

  <Story id="components-tabs--tabs-reversed" />
</Canvas>

```html
<div class="uq-tabs uq-tabs--outline uq-tabs--reversed">...</div>
```
