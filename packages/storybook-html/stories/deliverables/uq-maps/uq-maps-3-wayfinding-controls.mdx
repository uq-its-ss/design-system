...
<Canvas withSource="open" withToolbar>
  {/* <Story height={240} id="deliverables-uq-maps-3-wayfinding-controls--wayfinding-control" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
...
<Canvas withSource="open" withToolbar>
  {/* <Story height={240} id="deliverables-uq-maps-3-wayfinding-controls--wayfinding-control-working" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
