...
<Canvas sourceState="hidden" withToolbar>
  <Story of={UqMaps4SearchComboStories.initial} />
</Canvas>
...
<Canvas sourceState="hidden" withToolbar>
  <Story of={UqMaps4SearchComboStories.focused} />
</Canvas>
...
<Canvas sourceState="hidden" withToolbar>
  <Story of={UqMaps4SearchComboStories.searching} />
</Canvas>
...
<Canvas sourceState="hidden" withToolbar>
  <Story of={UqMaps4SearchComboStories.searchingNoResults} />
</Canvas>
...
<Canvas sourceState="hidden" withToolbar>
  <Story of={UqMaps4SearchComboStories.searchingError} />
</Canvas>
...
<Canvas sourceState="hidden" withToolbar>
  <Story of={UqMaps4SearchComboStories.searchingInCategory} />
</Canvas>
