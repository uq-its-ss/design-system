...
<Canvas of={UqMaps4SearchComboStories.initial} />
...
<Canvas of={UqMaps4SearchComboStories.focused} />

## 4C. With search value

### Basic usage

<Canvas of={UqMaps4SearchComboStories.searching} />

## 4D. With search value but no results

### Basic usage

<Canvas of={UqMaps4SearchComboStories.searchingNoResults} />

## 4E. With search value but with search error

### Basic usage

<Canvas of={UqMaps4SearchComboStories.searchingError} />
...
<Canvas of={UqMaps4SearchComboStories.searchingInCategory} />
