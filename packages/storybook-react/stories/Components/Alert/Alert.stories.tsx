...
export const showcase = {
  render: () => (
    ...
    >
      <Component variant="info">Info variant.</Component>
      <Component variant="warning">Warning variant.</Component>
      <Component variant="error">Error variant.</Component>
      <Component variant="success">Success variant.</Component>

      <Component variant="info" global={true}>
        Global info variant.
      </Component>
      <Component variant="warning" global={true}>
        Global warning variant.
      </Component>
      <Component variant="error" global={true}>
        Global error variant.
      </Component>
      <Component variant="success" global={true}>
      ...
      <Component variant="info" suffix={<a href="#">Learn more</a>}>
        A link can be specified in the suffix.
      </Component>
      <Component title="With title" variant="info">
        If supplied, the title should be a very short summary of the message.
      </Component>
      <Component title="With HTML" variant="info">
